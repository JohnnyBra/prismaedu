...
APPS=(
  ...
  "/home/javier/excursiones/excursionesv2|schooltrip-api|npm run build|npm run install:all|pm2 restart schooltrip-api && pm2 restart schooltrip-web|Excursiones (Salidas)"
