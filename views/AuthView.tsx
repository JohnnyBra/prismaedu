    ...
    return (
      <div className="w-full max-w-4xl animate-in fade-in slide-in-from-right-8 duration-300">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
          {/* Google Login Option for Teachers */}
          {selectedContext === 'SCHOOL' && (
             <a
               href="/auth/google"
               className="bg-white/95 backdrop-blur-sm p-4 rounded-xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all flex flex-col items-center border border-white/20 group"
             >
                <div className="mb-3 w-20 h-20 rounded-full flex items-center justify-center bg-red-100 text-red-600 group-hover:bg-red-600 group-hover:text-white transition-colors">
                ...
                <span className="font-bold text-gray-800 text-center text-sm">Entrar con Google</span>
                <span className="text-xs text-gray-400 uppercase mt-1">Cuenta Colegio</span>
             </a>
          )}
