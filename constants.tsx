...
export const AVATAR_ITEMS: AvatarItem[] = [
  ...
  // ═══════════════════════════════════════
  {
    ...
    svg: '<path d="M30 66 L70 66 L70 70 L66 70 L66 90 Q66 92 64 92 L52 92 L52 70 L48 70 L48 92 L36 92 Q34 92 34 90 L34 70 L30 70Z" fill="#3B82F6"/><line x1="50" y1="66" x2="50" y2="70" stroke="#1D4ED8" stroke-width="1"/><rect x="44" y="66" width="12" height="4" rx="1" fill="none" stroke="#1D4ED8" stroke-width="0.5"/>'
  },
  {
    id: 'bot_2', type: 'bottom', name: 'Pantalón Chándal', cost: 25,
    svg: '<path d="M28 66 L72 66 L72 70 L68 70 L68 92 Q68 94 66 94 L52 94 L52 70 L48 70 L48 94 L34 94 Q32 94 32 92 L32 70 L28 70Z" fill="#374151"/><line x1="30" y1="68" x2="72" y2="68" stroke="#4B5563" stroke-width="1"/><line x1="40" y1="70" x2="40" y2="90" stroke="#4B5563" stroke-width="0.8"/><line x1="60" y1="70" x2="60" y2="90" stroke="#4B5563" stroke-width="0.8"/>'
  },
  {
  ...
  },
  {
    ...
    svg: '<path d="M30 66 L70 66 L70 70 L66 70 L66 80 Q66 82 64 82 L52 82 L52 70 L48 70 L48 82 L36 82 Q34 82 34 80 L34 70 L30 70Z" fill="#F97316"/><line x1="50" y1="66" x2="50" y2="70" stroke="#EA580C" stroke-width="1"/><line x1="30" y1="68" x2="70" y2="68" stroke="#EA580C" stroke-width="0.8"/>'
  },
  {
    id: 'bot_5', type: 'bottom', name: 'Pantalón Camuflaje', cost: 120,
    svg: '<path d="M30 66 L70 66 L70 70 L66 70 L66 90 Q66 92 64 92 L52 92 L52 70 L48 70 L48 92 L36 92 Q34 92 34 90 L34 70 L30 70Z" fill="#4D7C0F"/><ellipse cx="40" cy="72" rx="4" ry="3" fill="#365314"/><ellipse cx="60" cy="74" rx="5" ry="3" fill="#365314"/><ellipse cx="42" cy="82" rx="3" ry="4" fill="#365314"/><ellipse cx="58" cy="86" rx="3" ry="3" fill="#365314"/><ellipse cx="50" cy="68" rx="6" ry="2" fill="#365314"/>'
  },
  {
